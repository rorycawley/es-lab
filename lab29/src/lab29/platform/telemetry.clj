...
;; and from any library's. A name with a digit in it would be mangled — `lab29`
...
(def ^:private logger (LoggerFactory/getLogger "lab29"))
...
(defonce ^:private requests
  (delay (instrument/instrument {:name            "lab29.slice.requests"
