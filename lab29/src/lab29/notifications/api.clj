(ns lab29.notifications.api
  "Notifications' public module API."
  (:require [lab29.notifications.get-notification :as get-notification]
            [lab29.notifications.port :as port]
            [lab29.notifications.send-receipt :as send-receipt]
            [lab29.platform.behaviour :as behaviour]))

(def contract
  {:module           :notifications
   :handles-commands #{:notifications/send-receipt}
   :consumes-events  #{}
   :publishes-events #{}
   :provides-queries #{:notifications/get-notification}})
