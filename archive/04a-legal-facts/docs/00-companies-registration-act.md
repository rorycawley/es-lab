# The Companies Registration Act
...
- **Applicant** means an identity-verified natural person who creates a draft or submits a registration application to register a company.
- **Authorised Officer** means a director of a registered company, or an identity-verified natural person duly authorised in writing by the directors of a registered company, to act on the company's behalf for the purposes of this Act. The initial Authorised Officers of a company upon registration are the directors named in the approved registration application.
- **Draft** means a preliminary record created by an applicant in the Registry system for the purpose of preparing a registration application. A draft has no legal existence and confers no rights or obligations.
- **Registration Application** means a formal lodgement made by an applicant upon submission of a completed draft. A registration application is a legal act.
- **Registered Company** means a company that has been registered under this Act, assigned a Registration Number, and entered in the Register. A registered company is a legal entity.
- **Registrar** means the officer of the Registry appointed to decide on registration applications and to maintain the Register.
- **Examiner** means an officer of the Registry appointed to examine registration applications and prepare cases for decision by the Registrar.
- **Registry** means the national companies registry established under this Act.
- **Register** means the authoritative record of all registered companies, maintained by the Registry under this Act.
- **Registration Number** means the unique permanent identifier assigned by the Registry to a registered company upon registration.
- **Registered Office Address** means an address within the jurisdiction at which legal notices may be served on the company, which the company has nominated as its registered address.
...
Identity verification is a prerequisite for a natural person to:

- Create a draft or submit a registration application as an Applicant
- Be named as a proposed director in a registration application
- Be recorded as a director of a registered company
- Act as an Authorised Officer

The Registry shall maintain a verified identity flag or record for every identity-verified natural person.

For users of the Registry system, identity verification may be supplied through a trusted third-party identity broker whose identity providers perform identity verification as part of signup and issue a digital identity accepted by the Registry.
...
- At least two proposed directors, each of whom is a distinct natural person
...
The Register shall retain the former names of any company that has changed its name, and such former names shall be protected from reuse for the period prescribed by the Registrar by order.
...
The filing fee is due at the point of submission and is non-refundable once the registration application has been formally created, regardless of the subsequent outcome of the application.
...
- The proposed company name satisfies Section 10
...
- The current registered office address, maintained up to date by notifications under Section 21
- The date of registration
- The current directors, maintained up to date by notifications under Section 21
...
Following any change of directors, the company must continue to have at least two current directors, each of whom is a distinct natural person whose identity has been verified by the Registry.

A notified registered office address must be plausible, valid, within the jurisdiction, and usable as an address at which legal notices may be served on the company.
...
Upon dissolution, the company ceases to exist as a legal entity from the date of dissolution. Dissolution does not remove the company from the historical record of the Register. The Registration Number of a dissolved company shall not be reused.
