(ns lab17.store
  ...
  Snapshots are replaceable derived data kept beside this source of record.
  This adapter preserves application-owned event identity, occurrence time and
  causal context, and assigns only storage coordinates.")
...
(defn append
  ...
  A production compare-and-append must perform the version check and write
  atomically."
