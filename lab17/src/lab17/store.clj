(ns lab17.store
  "The log, unchanged since lab 11 — and untouched by anything in this lab.

  A snapshot is not part of the store. It is a cache of a fold, kept beside
  the log, and the log neither knows nor cares that one exists.")
