...
;; and from any library's. A name with a digit in it would be mangled — `lab26`
...
(def ^:private logger (LoggerFactory/getLogger "lab26"))
...
(defonce ^:private requests
  (delay (instrument/instrument {:name            "lab26.slice.requests"
