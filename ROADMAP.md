...
| 04 | planned | `legal-facts` | The register IS the legal reality. A company record entered in the register is a legal fact: immutable, traceable to law, and distinct from the application process that created it. Proves legal fact as a first-class design concept — including what it means for schema design, mutation rules, and requirements traceability — using incorporation as the domain. |
